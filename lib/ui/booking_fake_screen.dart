...
class BookingFakeScreen extends StatefulWidget {
  @override
  _BookingFakeScreenState createState() => _BookingFakeScreenState();
}

class _BookingFakeScreenState extends State<BookingFakeScreen> {
